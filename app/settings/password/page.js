  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-base font-semibold text-gray-800">パスワードを変更</h1>
      </div>
      ...
      {sent ? (
        <div className="text-center py-12 px-4">
          ...
          <p className="text-sm font-medium text-gray-700 mb-1">メールを送信しました</p>
          <p className="text-xs text-gray-400 mb-6">{email} にパスワードリセット用のリンクを送りました。</p>
          <Link
            href="/settings"
